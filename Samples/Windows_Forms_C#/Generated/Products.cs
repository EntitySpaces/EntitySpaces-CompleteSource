...
namespace BusinessObjects
{
	...
	public partial class Products : esProducts
	{
        ...
        [DataMember(Name="OrderDetailsCollectionByProductID", EmitDefaultValue = false)]
        private OrderDetailsCollection __OrderDetailsCollectionByProductID
        {
            get 
			{ 
                if (this._OrderDetailsCollectionByProductID != null)
                {
                    this._OrderDetailsCollectionByProductID.CombineDeletedEntities();
                }			
				return this._OrderDetailsCollectionByProductID; 
			}
            ...
            set
            {
                this._OrderDetailsCollectionByProductID = value;
				this._OrderDetailsCollectionByProductID.SeparateDeletedEntities();
                this.SetPostSave("OrderDetailsCollectionByProductID", this._OrderDetailsCollectionByProductID);
