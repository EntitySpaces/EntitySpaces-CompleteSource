...
namespace BusinessObjects
{
	...
	public partial class Employees : esEmployees
	{
        ...
        private EmployeesCollection __EmployeesCollectionByReportsTo
        {
            get 
			{ 
                if (this._EmployeesCollectionByReportsTo != null)
                {
                    this._EmployeesCollectionByReportsTo.CombineDeletedEntities();
                }			
				return this._EmployeesCollectionByReportsTo; 
			}
            ...
            set
            {
                this._EmployeesCollectionByReportsTo = value;
				this._EmployeesCollectionByReportsTo.SeparateDeletedEntities();
                this.SetPostSave("EmployeesCollectionByReportsTo", this._EmployeesCollectionByReportsTo);
        ...
        // For DataContract Serialization Only
        [DataMember(Name="EmployeeTerritoriesCollectionByEmployeeID", EmitDefaultValue = false)]
        private EmployeeTerritoriesCollection __EmployeeTerritoriesCollectionByEmployeeID
        {
            get 
			{ 
                if (this._EmployeeTerritoriesCollectionByEmployeeID != null)
                {
                    this._EmployeeTerritoriesCollectionByEmployeeID.CombineDeletedEntities();
                }			
				return this._EmployeeTerritoriesCollectionByEmployeeID; 
			}
            ...
            set
            {
                this._EmployeeTerritoriesCollectionByEmployeeID = value;
				this._EmployeeTerritoriesCollectionByEmployeeID.SeparateDeletedEntities();
                this.SetPostSave("EmployeeTerritoriesCollectionByEmployeeID", this._EmployeeTerritoriesCollectionByEmployeeID);
        ...
        // For DataContract Serialization Only
        [DataMember(Name="OrdersCollectionByEmployeeID", EmitDefaultValue = false)]
        private OrdersCollection __OrdersCollectionByEmployeeID
        {
            get 
			{ 
                if (this._OrdersCollectionByEmployeeID != null)
                {
                    this._OrdersCollectionByEmployeeID.CombineDeletedEntities();
                }			
				return this._OrdersCollectionByEmployeeID; 
			}
            ...
            set
            {
                this._OrdersCollectionByEmployeeID = value;
				this._OrdersCollectionByEmployeeID.SeparateDeletedEntities();
                this.SetPostSave("OrdersCollectionByEmployeeID", this._OrdersCollectionByEmployeeID);
