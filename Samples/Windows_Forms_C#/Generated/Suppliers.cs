...
namespace BusinessObjects
{
	...
	public partial class Suppliers : esSuppliers
	{
        ...
        [DataMember(Name="ProductsCollectionBySupplierID", EmitDefaultValue = false)]
        private ProductsCollection __ProductsCollectionBySupplierID
        {
            get 
			{ 
                if (this._ProductsCollectionBySupplierID != null)
                {
                    this._ProductsCollectionBySupplierID.CombineDeletedEntities();
                }			
				return this._ProductsCollectionBySupplierID; 
			}
            ...
            set
            {
                this._ProductsCollectionBySupplierID = value;
				this._ProductsCollectionBySupplierID.SeparateDeletedEntities();
                this.SetPostSave("ProductsCollectionBySupplierID", this._ProductsCollectionBySupplierID);
