...
#End Region	
	...
	Partial Public Class Suppliers 
        ...
        <DataMember(Name:="ProductsCollectionBySupplierID", EmitDefaultValue:=False)> _
        Private Property __ProductsCollectionBySupplierID As ProductsCollection
            Get 
                If Not Me._ProductsCollectionBySupplierID Is Nothing Then
                    Me._ProductsCollectionBySupplierID.CombineDeletedEntities()
                End If
			...
			Set(ByVal value As ProductsCollection)
                Me._ProductsCollectionBySupplierID = Value
				Me._ProductsCollectionBySupplierID.SeparateDeletedEntities()
				Me.SetPostSave("ProductsCollectionBySupplierID", Me._ProductsCollectionBySupplierID)
