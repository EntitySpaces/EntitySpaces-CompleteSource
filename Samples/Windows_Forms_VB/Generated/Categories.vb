...
#End Region	
	...
	Partial Public Class Categories 
        ...
        <DataMember(Name:="ProductsCollectionByCategoryID", EmitDefaultValue:=False)> _
        Private Property __ProductsCollectionByCategoryID As ProductsCollection
            Get 
                If Not Me._ProductsCollectionByCategoryID Is Nothing Then
                    Me._ProductsCollectionByCategoryID.CombineDeletedEntities()
                End If
			...
			Set(ByVal value As ProductsCollection)
                Me._ProductsCollectionByCategoryID = Value
				Me._ProductsCollectionByCategoryID.SeparateDeletedEntities()
				Me.SetPostSave("ProductsCollectionByCategoryID", Me._ProductsCollectionByCategoryID)
