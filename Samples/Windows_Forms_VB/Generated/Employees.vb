...
#End Region	
	...
	Partial Public Class Employees 
        ...
        <DataMember(Name:="EmployeesCollectionByReportsTo", EmitDefaultValue:=False)> _
        Private Property __EmployeesCollectionByReportsTo As EmployeesCollection
            Get 
                If Not Me._EmployeesCollectionByReportsTo Is Nothing Then
                    Me._EmployeesCollectionByReportsTo.CombineDeletedEntities()
                End If
			...
			Set(ByVal value As EmployeesCollection)
                Me._EmployeesCollectionByReportsTo = Value
				Me._EmployeesCollectionByReportsTo.SeparateDeletedEntities()
				Me.SetPostSave("EmployeesCollectionByReportsTo", Me._EmployeesCollectionByReportsTo)
        ...
        ' For DataContract Serialization Only
        <DataMember(Name:="EmployeeTerritoriesCollectionByEmployeeID", EmitDefaultValue:=False)> _
        Private Property __EmployeeTerritoriesCollectionByEmployeeID As EmployeeTerritoriesCollection
            Get 
                If Not Me._EmployeeTerritoriesCollectionByEmployeeID Is Nothing Then
                    Me._EmployeeTerritoriesCollectionByEmployeeID.CombineDeletedEntities()
                End If
			...
			Set(ByVal value As EmployeeTerritoriesCollection)
                Me._EmployeeTerritoriesCollectionByEmployeeID = Value
				Me._EmployeeTerritoriesCollectionByEmployeeID.SeparateDeletedEntities()
				Me.SetPostSave("EmployeeTerritoriesCollectionByEmployeeID", Me._EmployeeTerritoriesCollectionByEmployeeID)
        ...
        ' For DataContract Serialization Only
        <DataMember(Name:="OrdersCollectionByEmployeeID", EmitDefaultValue:=False)> _
        Private Property __OrdersCollectionByEmployeeID As OrdersCollection
            Get 
                If Not Me._OrdersCollectionByEmployeeID Is Nothing Then
                    Me._OrdersCollectionByEmployeeID.CombineDeletedEntities()
                End If
			...
			Set(ByVal value As OrdersCollection)
                Me._OrdersCollectionByEmployeeID = Value
				Me._OrdersCollectionByEmployeeID.SeparateDeletedEntities()
				Me.SetPostSave("OrdersCollectionByEmployeeID", Me._OrdersCollectionByEmployeeID)
