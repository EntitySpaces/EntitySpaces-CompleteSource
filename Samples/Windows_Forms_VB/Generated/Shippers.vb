...
#End Region	
	...
	Partial Public Class Shippers 
        ...
        <DataMember(Name:="OrdersCollectionByShipVia", EmitDefaultValue:=False)> _
        Private Property __OrdersCollectionByShipVia As OrdersCollection
            Get 
                If Not Me._OrdersCollectionByShipVia Is Nothing Then
                    Me._OrdersCollectionByShipVia.CombineDeletedEntities()
                End If
			...
			Set(ByVal value As OrdersCollection)
                Me._OrdersCollectionByShipVia = Value
				Me._OrdersCollectionByShipVia.SeparateDeletedEntities()
				Me.SetPostSave("OrdersCollectionByShipVia", Me._OrdersCollectionByShipVia)
