...
#End Region	
	...
	Partial Public Class CustomerDemographics 
        ...
        <DataMember(Name:="CustomerCustomerDemoCollectionByCustomerTypeID", EmitDefaultValue:=False)> _
        Private Property __CustomerCustomerDemoCollectionByCustomerTypeID As CustomerCustomerDemoCollection
            Get 
                If Not Me._CustomerCustomerDemoCollectionByCustomerTypeID Is Nothing Then
                    Me._CustomerCustomerDemoCollectionByCustomerTypeID.CombineDeletedEntities()
                End If
			...
			Set(ByVal value As CustomerCustomerDemoCollection)
                Me._CustomerCustomerDemoCollectionByCustomerTypeID = Value
				Me._CustomerCustomerDemoCollectionByCustomerTypeID.SeparateDeletedEntities()
				Me.SetPostSave("CustomerCustomerDemoCollectionByCustomerTypeID", Me._CustomerCustomerDemoCollectionByCustomerTypeID)
