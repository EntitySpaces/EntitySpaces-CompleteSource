...
#End Region	
	...
	Partial Public Class Region 
        ...
        <DataMember(Name:="TerritoriesCollectionByRegionID", EmitDefaultValue:=False)> _
        Private Property __TerritoriesCollectionByRegionID As TerritoriesCollection
            Get 
                If Not Me._TerritoriesCollectionByRegionID Is Nothing Then
                    Me._TerritoriesCollectionByRegionID.CombineDeletedEntities()
                End If
			...
			Set(ByVal value As TerritoriesCollection)
                Me._TerritoriesCollectionByRegionID = Value
				Me._TerritoriesCollectionByRegionID.SeparateDeletedEntities()
				Me.SetPostSave("TerritoriesCollectionByRegionID", Me._TerritoriesCollectionByRegionID)
