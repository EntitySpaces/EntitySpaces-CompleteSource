...
#End Region	
	...
	Partial Public Class Customers 
        ...
        <DataMember(Name:="CustomerCustomerDemoCollectionByCustomerID", EmitDefaultValue:=False)> _
        Private Property __CustomerCustomerDemoCollectionByCustomerID As CustomerCustomerDemoCollection
            Get 
                If Not Me._CustomerCustomerDemoCollectionByCustomerID Is Nothing Then
                    Me._CustomerCustomerDemoCollectionByCustomerID.CombineDeletedEntities()
                End If
			...
			Set(ByVal value As CustomerCustomerDemoCollection)
                Me._CustomerCustomerDemoCollectionByCustomerID = Value
				Me._CustomerCustomerDemoCollectionByCustomerID.SeparateDeletedEntities()
				Me.SetPostSave("CustomerCustomerDemoCollectionByCustomerID", Me._CustomerCustomerDemoCollectionByCustomerID)
        ...
        ' For DataContract Serialization Only
        <DataMember(Name:="OrdersCollectionByCustomerID", EmitDefaultValue:=False)> _
        Private Property __OrdersCollectionByCustomerID As OrdersCollection
            Get 
                If Not Me._OrdersCollectionByCustomerID Is Nothing Then
                    Me._OrdersCollectionByCustomerID.CombineDeletedEntities()
                End If
			...
			Set(ByVal value As OrdersCollection)
                Me._OrdersCollectionByCustomerID = Value
				Me._OrdersCollectionByCustomerID.SeparateDeletedEntities()
				Me.SetPostSave("OrdersCollectionByCustomerID", Me._OrdersCollectionByCustomerID)
