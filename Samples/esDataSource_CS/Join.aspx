...
<body>
    ...
    <div>
        ...
        <cc1:esdatasource id="EsDataSource1" runat="server" 
            onescreateentity="EsDataSource1_esCreateEntity" onesselect="EsDataSource1_esSelect" AutoPaging="True" AutoSorting="True" OnesException="EsDataSource1_esException"></cc1:esdatasource>
    </form>
</body>
</html>
