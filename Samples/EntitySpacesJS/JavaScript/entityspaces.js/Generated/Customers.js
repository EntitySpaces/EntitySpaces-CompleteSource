...
(function (es) { //myNS = "myNameSpace" ... for example purposes
	...
	es.objects.Customers = es.defineEntity(function () {
		...
		this.UpToCustomerDemographicsCollection = es.defineLazyLoader(this, 'UpToCustomerDemographicsCollection');
		this.CustomerCustomerDemoCollectionByCustomerID = es.defineLazyLoader(this, 'CustomerCustomerDemoCollectionByCustomerID');
		this.OrdersCollectionByCustomerID = es.defineLazyLoader(this, 'OrdersCollectionByCustomerID');
	});
