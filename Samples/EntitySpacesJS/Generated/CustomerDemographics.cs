...
Date Generated       : 3/18/2012 8:06:01 AM
===============================================================================
*/
...
namespace BusinessObjects
{
	...
	public partial class CustomerDemographics : esCustomerDemographics
	{
        ...
        [DataMember(Name="CustomerCustomerDemoCollectionByCustomerTypeID", EmitDefaultValue = false)]
        private CustomerCustomerDemoCollection __CustomerCustomerDemoCollectionByCustomerTypeID
        {
            get 
			{ 
                if (this._CustomerCustomerDemoCollectionByCustomerTypeID != null)
                {
                    this._CustomerCustomerDemoCollectionByCustomerTypeID.CombineDeletedEntities();
                }			
				return this._CustomerCustomerDemoCollectionByCustomerTypeID; 
			}
            ...
            set
            {
                this._CustomerCustomerDemoCollectionByCustomerTypeID = value;
				this._CustomerCustomerDemoCollectionByCustomerTypeID.SeparateDeletedEntities();
                this.SetPostSave("CustomerCustomerDemoCollectionByCustomerTypeID", this._CustomerCustomerDemoCollectionByCustomerTypeID);
