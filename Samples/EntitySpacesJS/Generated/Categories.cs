...
namespace BusinessObjects
{
	...
	public partial class Categories : esCategories
	{
        ...
        [DataMember(Name="ProductsCollectionByCategoryID", EmitDefaultValue = false)]
        private ProductsCollection __ProductsCollectionByCategoryID
        {
            get 
			{ 
                if (this._ProductsCollectionByCategoryID != null)
                {
                    this._ProductsCollectionByCategoryID.CombineDeletedEntities();
                }			
				return this._ProductsCollectionByCategoryID; 
			}
            ...
            set
            {
                this._ProductsCollectionByCategoryID = value;
				this._ProductsCollectionByCategoryID.SeparateDeletedEntities();
                this.SetPostSave("ProductsCollectionByCategoryID", this._ProductsCollectionByCategoryID);
