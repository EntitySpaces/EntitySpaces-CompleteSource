...
namespace BusinessObjects
{
	...
	public partial class Region : esRegion
	{
        ...
        [DataMember(Name="TerritoriesCollectionByRegionID", EmitDefaultValue = false)]
        private TerritoriesCollection __TerritoriesCollectionByRegionID
        {
            get 
			{ 
                if (this._TerritoriesCollectionByRegionID != null)
                {
                    this._TerritoriesCollectionByRegionID.CombineDeletedEntities();
                }			
				return this._TerritoriesCollectionByRegionID; 
			}
            ...
            set
            {
                this._TerritoriesCollectionByRegionID = value;
				this._TerritoriesCollectionByRegionID.SeparateDeletedEntities();
                this.SetPostSave("TerritoriesCollectionByRegionID", this._TerritoriesCollectionByRegionID);
