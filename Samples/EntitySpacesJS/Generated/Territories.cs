...
namespace BusinessObjects
{
	...
	public partial class Territories : esTerritories
	{
        ...
        [DataMember(Name="EmployeeTerritoriesCollectionByTerritoryID", EmitDefaultValue = false)]
        private EmployeeTerritoriesCollection __EmployeeTerritoriesCollectionByTerritoryID
        {
            get 
			{ 
                if (this._EmployeeTerritoriesCollectionByTerritoryID != null)
                {
                    this._EmployeeTerritoriesCollectionByTerritoryID.CombineDeletedEntities();
                }			
				return this._EmployeeTerritoriesCollectionByTerritoryID; 
			}
            ...
            set
            {
                this._EmployeeTerritoriesCollectionByTerritoryID = value;
				this._EmployeeTerritoriesCollectionByTerritoryID.SeparateDeletedEntities();
                this.SetPostSave("EmployeeTerritoriesCollectionByTerritoryID", this._EmployeeTerritoriesCollectionByTerritoryID);
