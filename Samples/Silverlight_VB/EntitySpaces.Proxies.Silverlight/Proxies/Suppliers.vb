...
Namespace Proxies
	...
	Partial Public Class SuppliersCollectionProxyStub 
		...
		Public Collection As New ObservableCollection (Of SuppliersProxyStub)
		
		Public Function IsDirty() As Boolean
			For Each obj As SuppliersProxyStub In Collection
				If obj.IsDirty() Then
					Return True
				End If
			Next
	...
	Partial Public Class SuppliersProxyStub
        ...
        Public Property HomePage As System.String
			...
			End Get
			Set(ByVal value As System.String)
				If Not String.Compare(_HomePage, value) = 0 Then
					_HomePage = value
					SetDirty("HomePage")
	...
	<XmlType(TypeName:="SuppliersQueryProxyStub")> _	
	<DataContract(Name:="SuppliersQuery", Namespace:= "http://www.entityspaces.net")> _	
	Partial Public Class SuppliersQueryProxyStub 
		...
		Public Shared Widening Operator CType(ByVal query As SuppliersQueryProxyStub) As String
			Return SuppliersQueryProxyStub.SerializeHelper.ToXml(query)
		End Operator
		...
		Public ReadOnly Property HomePage As esQueryItem
			Get
				Return new esQueryItem(Me, "HomePage", esSystemType.String)
			End Get
		End Property 
