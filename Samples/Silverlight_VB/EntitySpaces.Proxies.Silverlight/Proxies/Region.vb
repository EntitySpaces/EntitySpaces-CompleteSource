...
Namespace Proxies
	...
	Partial Public Class RegionCollectionProxyStub 
		...
		Public Collection As New ObservableCollection (Of RegionProxyStub)
		
		Public Function IsDirty() As Boolean
			For Each obj As RegionProxyStub In Collection
				If obj.IsDirty() Then
					Return True
				End If
			Next
	...
	Partial Public Class RegionProxyStub
        ...
        Public Property RegionDescription As System.String
			...
			Set(ByVal value As System.String)
				If Not String.Compare(_RegionDescription, value) = 0 Then
	...
	<XmlType(TypeName:="RegionQueryProxyStub")> _	
	<DataContract(Name:="RegionQuery", Namespace:= "http://www.entityspaces.net")> _	
	Partial Public Class RegionQueryProxyStub 
		...
		Public Shared Widening Operator CType(ByVal query As RegionQueryProxyStub) As String
			Return RegionQueryProxyStub.SerializeHelper.ToXml(query)
		End Operator
		...
		Public ReadOnly Property RegionDescription As esQueryItem
			Get
				Return new esQueryItem(Me, "RegionDescription", esSystemType.String)
			End Get
		End Property 
