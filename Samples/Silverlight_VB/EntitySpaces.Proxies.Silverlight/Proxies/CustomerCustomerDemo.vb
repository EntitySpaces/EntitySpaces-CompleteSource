...
Namespace Proxies
	...
	Partial Public Class CustomerCustomerDemoCollectionProxyStub 
		...
		Public Collection As New ObservableCollection (Of CustomerCustomerDemoProxyStub)
		
		Public Function IsDirty() As Boolean
			For Each obj As CustomerCustomerDemoProxyStub In Collection
				If obj.IsDirty() Then
					Return True
				End If
			Next
	...
	<XmlType(TypeName:="CustomerCustomerDemoQueryProxyStub")> _	
	...
	Partial Public Class CustomerCustomerDemoQueryProxyStub 
		...
		Public Shared Widening Operator CType(ByVal query As CustomerCustomerDemoQueryProxyStub) As String
			Return CustomerCustomerDemoQueryProxyStub.SerializeHelper.ToXml(query)
		End Operator
