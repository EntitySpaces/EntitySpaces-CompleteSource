...
Namespace BusinessObjects
	...
	<Table(Name:="CustomerDemographics")> _	
	Partial Public Class CustomerDemographics 
		...
		Public Overrides Property CustomerDesc As System.String
			Get
				Return MyBase.CustomerDesc
			End Get
			Set
				MyBase.CustomerDesc = value
			End Set
		End Property
...
#Region ".str() Properties"
			...
			If Not col Is Nothing Then
				...
				If value Is Nothing OrElse value.GetType().ToString() = "System.String" Then
					...
					Select Case name
						...
						Case "CustomerDesc"
							Me.str().CustomerDesc = CType(value, string)
		...
		NotInheritable Public Class esStrings
			...
			Public Sub New(ByVal entity As esCustomerDemographics)
				Me.entity = entity
			End Sub				
			...
			Public Property CustomerDesc As System.String 
				Get
					Dim data_ As System.String = entity.CustomerDesc
				...
				Set(ByVal Value as System.String)
					If String.IsNullOrEmpty(value) Then
						entity.CustomerDesc = Nothing
					Else
						entity.CustomerDesc = Convert.ToString(Value)
					End If
				End Set
			End Property
		  

			Private entity As esCustomerDemographics
		End Class
...
#End Region
	...
	MustInherit Public Partial Class esCustomerDemographicsCollection
		Inherits CollectionBase(Of CustomerDemographics)
