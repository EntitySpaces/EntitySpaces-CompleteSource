...
Namespace BusinessObjects
	...
	<Table(Name:="EmployeeTerritories")> _	
...
#Region ".str() Properties"
		...
		NotInheritable Public Class esStrings
			...
			Public Sub New(ByVal entity As esEmployeeTerritories)
				Me.entity = entity
			End Sub				
			...
			Private entity As esEmployeeTerritories
		End Class
...
#End Region
	...
	MustInherit Public Partial Class esEmployeeTerritoriesCollection
		Inherits CollectionBase(Of EmployeeTerritories)
