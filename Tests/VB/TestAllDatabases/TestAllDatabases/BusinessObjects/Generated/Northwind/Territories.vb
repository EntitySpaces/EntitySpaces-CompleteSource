...
Namespace BusinessObjects
	...
	Partial Public Class Territories 
		...
		Public Overrides Property TerritoryID As System.String
			Get
		...
		Public Overrides Property TerritoryDescription As System.String
			Get
				Return MyBase.TerritoryDescription
			End Get
			Set
				MyBase.TerritoryDescription = value
			End Set
		End Property
...
#Region ".str() Properties"
				...
				If value Is Nothing OrElse value.GetType().ToString() = "System.String" Then
					...
					Select Case name
						...
						Case "TerritoryDescription"
							Me.str().TerritoryDescription = CType(value, string)
		...
		NotInheritable Public Class esStrings
			...
			Public Sub New(ByVal entity As esTerritories)
				Me.entity = entity
			End Sub				
			...
			Public Property TerritoryID As System.String 
				Get
					Dim data_ As System.String = entity.TerritoryID
				...
				Set(ByVal Value as System.String)
					...
					Else
						entity.TerritoryID = Convert.ToString(Value)
					End If
				End Set
			End Property
			...
			Public Property TerritoryDescription As System.String 
				Get
					Dim data_ As System.String = entity.TerritoryDescription
				...
				Set(ByVal Value as System.String)
					If String.IsNullOrEmpty(value) Then
						entity.TerritoryDescription = Nothing
					Else
						entity.TerritoryDescription = Convert.ToString(Value)
					End If
				End Set
			End Property
			...
			Private entity As esTerritories
		End Class
...
#End Region
	...
	MustInherit Public Partial Class esTerritoriesCollection
		Inherits CollectionBase(Of Territories)
