...
Namespace BusinessObjects
	...
	Partial Public Class Employees 
		...
		<Column(IsPrimaryKey: = false, CanBeNull: = true)> _
		Public Overrides Property TitleOfCourtesy As System.String
			Get
				Return MyBase.TitleOfCourtesy
			End Get
			Set
				MyBase.TitleOfCourtesy = value
			End Set
		End Property

		<Column(IsPrimaryKey: = false, CanBeNull: = true)> _
		Public Overrides Property BirthDate As Nullable(Of System.DateTime)
			Get
		...
		<Column(IsPrimaryKey: = false, CanBeNull: = true)> _
		Public Overrides Property Extension As System.String
			Get
				Return MyBase.Extension
			End Get
			Set
				MyBase.Extension = value
			End Set
		End Property

		<Column(IsPrimaryKey: = false, CanBeNull: = true)> _
		Public Overrides Property Photo As System.Byte()
			Get
				Return MyBase.Photo
			End Get
			Set
		...
		<Column(IsPrimaryKey: = false, CanBeNull: = true)> _
		Public Overrides Property ReportsTo As Nullable(Of System.Int32)
			Get
				Return MyBase.ReportsTo
			End Get
			Set
				MyBase.ReportsTo = value
			End Set
		End Property

		<Column(IsPrimaryKey: = false, CanBeNull: = true)> _
		Public Overrides Property PhotoPath As System.String
			Get
				Return MyBase.PhotoPath
			End Get
			Set
				MyBase.PhotoPath = value
			End Set
		End Property
...
#End Region
	...
	MustInherit Public Partial Class esEmployeesCollection
		Inherits CollectionBase(Of Employees)
