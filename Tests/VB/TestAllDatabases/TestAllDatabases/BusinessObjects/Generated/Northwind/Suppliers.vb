...
Namespace BusinessObjects
	...
	Partial Public Class Suppliers 
		...
		<Column(IsPrimaryKey: = false, CanBeNull: = true)> _
		Public Overrides Property HomePage As System.String
			Get
...
#Region ".str() Properties"
			...
			If Not col Is Nothing Then
				...
				If value Is Nothing OrElse value.GetType().ToString() = "System.String" Then
					...
					Select Case name
						...
						Case "HomePage"
							Me.str().HomePage = CType(value, string)
		...
		NotInheritable Public Class esStrings
			...
			Public Sub New(ByVal entity As esSuppliers)
				Me.entity = entity
			End Sub				
			...
			Public Property HomePage As System.String 
				Get
					Dim data_ As System.String = entity.HomePage
				...
				Set(ByVal Value as System.String)
					If String.IsNullOrEmpty(value) Then
						entity.HomePage = Nothing
					Else
						entity.HomePage = Convert.ToString(Value)
					End If
				End Set
			End Property
		  

			Private entity As esSuppliers
		End Class
...
#End Region
	...
	MustInherit Public Partial Class esSuppliersCollection
		Inherits CollectionBase(Of Suppliers)
